...
export interface IDrawerRepository {
  ...
  update(id: string, input: UpdateDrawerInput): Promise<Drawer | null>;
  delete(id: string): Promise<void>;
...
export interface ICompartmentRepository {
  ...
  update(id: string, input: UpdateCompartmentInput): Promise<Compartment | null>;
...
export interface ISubCompartmentRepository {
  ...
  update(id: string, input: UpdateSubCompartmentInput): Promise<SubCompartment | null>;
