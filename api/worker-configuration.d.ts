/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: f72bb659855a85792aa6af3cb15ee393)
// Runtime types generated with workerd@1.20251217.0 2026-01-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RoomSync";
	}
	interface Env {
		JWT_SECRET: string;
		TURNSTILE_SECRET_KEY: string;
		ROOM_SYNC: DurableObjectNamespace<import("./src/index").RoomSync>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
